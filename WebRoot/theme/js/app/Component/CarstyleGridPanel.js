 ...
 */
Ext.define('MyApp.Component.CarstyleGridPanel',{
    extend:'Ext.grid.Panel',
    config:{id:'CarstyleGridPanel_id'},
    constructor:function(){
        var gp = this;
        
        var store = Ext.ajaxModelLoader('MyApp.Model.ListCarstyle');
        ...
        this.superclass.constructor.call(this,{
            ...
            columns: [
                ...
                {text:'车型', dataIndex: 'name', sortable: false, menuDisabled:true, width:'20%'},
            ...
            tbar: [
                ...
                text: '添加',
                handler: function(){
                    Ext.create('MyApp.Component.SaveCarstyleWindow',0);
                }
            },{
                xtype: 'tbseparator'
            },
            	...
            	cellClick: function(thisTab, td, cellIndex,record,tr,rowIndex,event,eventObj) {
                    if(cellIndex == 2) {
                        ...
                        if(extTarget.hasCls('edit')) {
                            Ext.create('MyApp.Component.SaveCarstyleWindow',record.get('id'));
                        }
                        
                        if(extTarget.hasCls('del')) {
                            Ext.Msg.confirm('系统提示','确认是否删除该车型',function(op){
                                if(op == 'yes') {
                                    Ext.ajaxModelLoader('MyApp.Model.DelCarstyle', {
                                        target:gp,
