...
Ext.define('MyApp.Component.LineEditWindow',{
    ...
    constructor:function(){
        var w = this;
        var ckModel = this.getCheckedModel('gridline_id');
        ...
        var formPanel = Ext.create('Ext.form.Panel',{
            ...
            listeners:{
                afterrender:function(){
                    setTimeout(function(){
                        drawLineMap = Ext.create('MyApp.Component.DrawLineMap');
                        if(ckModel) drawLineMap.drawLine(ckModel.getData().path);
           ...
           padding:20,
            ...
            buttons:[{
                ...
                handler:function(){
                    ...
                    if(drawLineMap.getDistance() > 0) win.show();
