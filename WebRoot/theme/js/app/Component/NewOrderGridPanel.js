 ...
 */
Ext.define('MyApp.Component.NewOrderGridPanel',{
    extend:'Ext.grid.Panel',
    config:{id:'NewOrderGridPanel_id',thisstore:null},
    constructor:function(){
        var gp = this;
        
        var store = Ext.ajaxModelLoader('MyApp.Model.ListOrder',{params:{status:0}});
        ...
        this.superclass.constructor.call(this,{
            ...
            columns: [
                ...
                {text:'预约时间', dataIndex: 'beginTime', sortable: true, menuDisabled:true, width:'15%'},
                ...
                {text:'预约电话', dataIndex:'carUserTel', sortable: true, menuDisabled:true, width:'15%'},
            ...
            listeners:{
                ...
                beforerender:function(){
                 ...
                 itemDblClick: function(thisTab, td, cellIndex,record,tr,rowIndex,event,eventObj) {
                       Ext.create('MyApp.Component.EditOrderWindow');
                 }
