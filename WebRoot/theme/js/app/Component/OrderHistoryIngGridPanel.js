 ...
 */
Ext.define('MyApp.Component.OrderHistoryIngGridPanel',{
    extend:'Ext.grid.Panel',
    config:{id:'OrderHistoryIngGridPanel_id'},
    constructor:function(){
        var gp = this;
        
        var store = Ext.ajaxModelLoader('MyApp.Model.ListOrder',{params:{status:2}});
            ...
            listeners:{
                ...
                beforerender:function(){
                 ...
                 itemDblClick: function(thisTab, td, cellIndex,record,tr,rowIndex,event,eventObj) {
                       Ext.create('MyApp.Component.DetailOrderWindow','OrderHistoryIngGridPanel_id');
                 }
            }
        });
    },
