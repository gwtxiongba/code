 ...
 */
Ext.define('MyApp.Component.ReportCarGridPanel',{
...
//       style:'margin: 7px auto; border:solid 1px #B5B5B5;',
        items:[{
        	...
        	border : false,
        	items:Ext.create('MyApp.Component.ReportCarleft')
        },{
        	...
        	style:'margin: 0px 3px; border:solid 1px #B5B5B5;',
        	border : false,
        	items:Ext.create('MyApp.Component.MonthReportGridPanel','monthStats1_id')
        }],
