 ...
 */
Ext.define('MyApp.Component.ReportCarleft',{
   extend:'Ext.grid.Panel',
   constructor:function(){
       var me = this;
       var store = Ext.ajaxModelLoader('MyApp.Model.ReportCar');
...
//                    Ext.getCmp(cmp).store.currentPage = 1;//搜索时重置页码为1
            ...
            listeners:{
                itemclick:function(view, record, item, index, e, eOpts){
                    var grid = Ext.getCmp('monthStats1_id');
                    var st = Ext.ajaxModelLoader('MyApp.Model.ReportMonth', {
                            params:{id:record.get('id'),type:1,begin_time:begin_time,end_time:end_time}
                         });
                    grid.bindStore(st);
                }
            },
