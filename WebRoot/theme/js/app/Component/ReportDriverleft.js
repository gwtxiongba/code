 ...
 */
Ext.define('MyApp.Component.ReportDriverleft',{
   extend:'Ext.grid.Panel',
   constructor:function(){
       var me = this;
       var store = Ext.ajaxModelLoader('MyApp.Model.ReportDriver');
       var begin_time=null;
       var end_time=null;
       
       me.superclass.constructor.call(this,{
           id:'reportDriverleft_id',
           //baseCls:'grid',
           frame:false,
           border:true,
           autoScroll:false,
...
//                    Ext.getCmp(cmp).store.currentPage = 1;//搜索时重置页码为1
            ...
            listeners:{
                itemclick:function(view, record, item, index, e, eOpts){
                    var grid = Ext.getCmp('monthStats2_id');
                    var st = Ext.ajaxModelLoader('MyApp.Model.ReportMonth', {
                            params:{id:record.get('id'),type:2,begin_time:begin_time,end_time:end_time}
                         });
                    grid.bindStore(st);
                }
            },
