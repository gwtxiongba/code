 ...
 */
Ext.define('MyApp.Component.WeizhangGridPanel',{
    extend:'Ext.grid.Panel',
    config:{id:'WeizhangGridPanel_id'},
    constructor:function(){
        var gp = this;
        
        var store = Ext.ajaxModelLoader('MyApp.Model.ListWeizhang');
        ...
        this.superclass.constructor.call(this,{
            ...
            tbar: [{
                ...
                handler: function(){
                    ...
                    Ext.create('MyApp.Component.SaveWeizhangWindow');
                }
            },{
                xtype: 'tbseparator'
            },{
                ...
                handler: function(){
                    Ext.Msg.confirm('系统确认','您将删除所选记录，是否继续？',function(btn){
                        if(btn=='yes') {
                            ...
                            Ext.ajaxModelLoader('MyApp.Model.DelWeizhang',{target: gp, params: {id:keys.join(',')}}).request();   
                        }
                    });
                }
            },{
